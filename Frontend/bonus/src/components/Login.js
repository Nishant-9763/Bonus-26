...
const Login = () => {
    ...
    const validate = () => {
      ...
      const onSubmit = (e)=>{
        ...
        .then((r)=>{console.log(r.data.data);localStorage.getItem("token",r.data.data)   ; navigate("/GetStudent") })
      ...
      <Row>
        <Col md={8}>
          <Form onSubmit={onSubmit}>
            ...
            <br/><br/><br/>
            If you are not a registered user please      <Link to={"/CreateUser"} >SIGNUP</Link>
          </Form>
        </Col>
      </Row>
    </Container>
